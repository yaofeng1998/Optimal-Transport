...
output1 = sinkhorn(c, m, n, A, b, x, 1e+2, iter, eps);
output2 = sinkhorn(c, m, n, A, b, x, 1e+3, iter, eps);
output3 = sinkhorn(c, m, n, A, b, x, 1e+4, iter, eps);
output4 = gd_entropy(c, m, n, A, b, x, 1e+2, 1e-5, iter, eps);
output5 = gd_entropy(c, m, n, A, b, x, 1e+3, 1e-5, iter, eps);
output6 = gd_entropy(c, m, n, A, b, x, 1e+4, 1e-5, iter, eps);
outputs_random = [output1, output2, output3, output4, output5, output6];
...
output5 = gd_entropy(c, m, n, A, b, x, 1e+3, 1e-5, iter, eps);
output6 = gd_entropy(c, m, n, A, b, x, 1e+4, 1e-5, iter, eps);
outputs_DoTmark = [output1, output2, output3, output4, output5, output6];
...
output5 = gd_entropy(c, m, n, A, b, x, 1e+3, 1e-5, iter, eps);
output6 = gd_entropy(c, m, n, A, b, x, 1e+4, 1e-5, iter, eps);
outputs_Caffarelli = [output1, output2, output3, output4, output5, output6];
...
if (m == 500) && (n == 500)
    ...
    output5 = gd_entropy(c, m, n, A, b, x, 1e+3, 1e-5, iter, eps);
    output6 = gd_entropy(c, m, n, A, b, x, 1e+4, 1e-5, iter, eps);
    outputs_Ricker = [output1, output2, output3, output4, output5, output6];
