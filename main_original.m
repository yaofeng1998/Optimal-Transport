function [outputs] = main_original(m, n, iter, eps, t, seed, save_dir)
...
output5 = admm(c, m, n, A, b, x, t, iter, eps);
outputs_random = [output1, output2, output3, output4, output5];
...
output4 = linprog_gurobi(c, m, n, A, b, 'interior point');
output5 = admm(c, m, n, A, b, x, t, iter, eps);
outputs_DoTmark = [output1, output2, output3, output4, output5];
...
output4 = linprog_gurobi(c, m, n, A, b, 'interior point');
output5 = admm(c, m, n, A, b, x, t, iter, eps);
outputs_Caffarelli = [output1, output2, output3, output4, output5];
...
if (m == 500) && (n == 500)
    ...
    output4 = linprog_gurobi(c, m, n, A, b, 'interior point');
    output5 = admm(c, m, n, A, b, x, t, iter, eps);
    outputs_Ricker = [output1, output2, output3, output4, output5];
